...
def main():
    # Заголовок програми
    st.markdown("<h1 style='text-align: center; color: darkred;'>GraphPlot – Візуалізація математичних функцій</h1>", unsafe_allow_html=True)
    ...
    if st.button("🎨 Побудувати графік"):
        try:
            ...
            fig.patch.set_facecolor("#f0f8ff")  # фон графіка
            ax.set_facecolor("#fffaf0")         # фон всередині координат
